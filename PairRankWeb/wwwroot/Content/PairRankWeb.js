...
{
 "use strict";
 var Global,PairRankWeb,Client,WebSharper,Operators,Mvu,App,Model,EndPoint,Item,Pair,PairRankWeb_JsonEncoder,PairRankWeb_JsonDecoder,PairRankWeb_GeneratedPrintf,GeneratedPrintf,PairRankWeb_Templates,PairRankWeb_Router,Obj,Pager,SC$1,List,T,Pages,UI,Var,Numeric,ClientSideJson,Provider,Client$1,Templates,Doc,JavaScript,Pervasives,Ref,Unchecked,Lazy,Page,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,Var$1,Message,AttrModule,View,Disabled,Strings,Event,UIEvent,WinnerOfPair,Seq,Router,EventTarget,WindowOrWorkerGlobalScope,JS,Object,Node,Collections,Dictionary,Option,Elt,EltUpdater,LazyExtensionsProxy,LazyRecord,HtmlModule,attr,System,Guid,List$1,FromView,Attrs,Snap,Sitelets,RouterOperators,Enumerator,T$1,Utils,RouterModule,Route,Abbrev,Fresh,SC$2,HashSet,Docs,ConcreteVar,Concurrency,Updates,DocElemNode,AttrProxy,TemplateInitializer,DynamicAttrNode,CheckedInput,Router$1,List$2,DictionaryUtil,Prepare,Slice,DomUtility,KeyCollection,CharacterData,An,Settings,Mailbox,CT,AsyncBody,Attrs$1,Dyn,Error,InvalidOperationException,Array,FSharpMap,Map,SC$3,Docs$1,RunState,NodeSet,Anims,SC$4,SC$5,Scheduler,SC$6,BalancedTree,Tree,Pair$1,PathUtil,SC$7,SC$8,AppendList,HashSetUtil,CancellationTokenSource,BindVar,String,ValueCollection,Queue,MapUtil,Easing,HashSet$1,Char,DomNodes,OperationCanceledException,SC$9,console,IntelliFactory,Runtime$1,JSON,Math,Date;
 Global=self;
 PairRankWeb=Global.PairRankWeb=Global.PairRankWeb||{};
 Client=PairRankWeb.Client=PairRankWeb.Client||{};
 ...
 Item=Client.Item=Client.Item||{};
 Pair=Client.Pair=Client.Pair||{};
 PairRankWeb_JsonEncoder=Global.PairRankWeb_JsonEncoder=Global.PairRankWeb_JsonEncoder||{};
 PairRankWeb_JsonDecoder=Global.PairRankWeb_JsonDecoder=Global.PairRankWeb_JsonDecoder||{};
 PairRankWeb_GeneratedPrintf=Global.PairRankWeb_GeneratedPrintf=Global.PairRankWeb_GeneratedPrintf||{};
 GeneratedPrintf=Global.GeneratedPrintf=Global.GeneratedPrintf||{};
 PairRankWeb_Templates=Global.PairRankWeb_Templates=Global.PairRankWeb_Templates||{};
 PairRankWeb_Router=Global.PairRankWeb_Router=Global.PairRankWeb_Router||{};
 Obj=WebSharper.Obj=WebSharper.Obj||{};
 Pager=Mvu.Pager=Mvu.Pager||{};
 SC$1=Global.StartupCode$PairRankWeb$Client=Global.StartupCode$PairRankWeb$Client||{};
 List=WebSharper.List=WebSharper.List||{};
 T=List.T=List.T||{};
 Pages=Client.Pages=Client.Pages||{};
 ...
 Disabled=Client.Disabled=Client.Disabled||{};
 Strings=WebSharper.Strings=WebSharper.Strings||{};
 Event=Global.Event;
 UIEvent=Global.UIEvent;
 WinnerOfPair=Client.WinnerOfPair=Client.WinnerOfPair||{};
 ...
 Elt=UI.Elt=UI.Elt||{};
 EltUpdater=Client$1.EltUpdater=Client$1.EltUpdater||{};
 ...
 Pair$1=Collections.Pair=Collections.Pair||{};
 ...
 {
  var a,a$1;
  a=App.Run(App.withLocalStorage({
   Encode:PairRankWeb_JsonEncoder.j(),
   Decode:PairRankWeb_JsonDecoder.j()
  },"PairRankStore",(a$1=App.CreatePaged(Client.initialModel(),Client.Update,Client.Render),App.WithCustomRouting(Client.router(),function(s)
  {
   return s.EndPoint;
  },Client.Navigate,a$1))));
 ...
 Client.initialModel=function()
 {
  SC$1.$cctor();
  return SC$1.initialModel;
 };
 Client.Update=function(msg,model)
 {
  var idToRemove,which,currentPair,winningItem,updatedModel;
  return msg.$==1?{
   $:1,
   $0:Model.New(model.EndPoint,"",new T({
    $:1,
    $0:Item.New(model.NextId,0,model.PendingItemValue),
    $1:model.Items
   }),model.NextId+1,model.PendingCombinations)
  }:msg.$==3?{
   $:1,
   $0:Model.New(model.EndPoint,msg.$0,model.Items,model.NextId,model.PendingCombinations)
  }:msg.$==2?(idToRemove=msg.$0,{
   $:1,
   $0:Model.New(model.EndPoint,model.PendingItemValue,List.filter(function(item)
   {
    return item.Id!==idToRemove;
   },model.Items),model.NextId,model.PendingCombinations)
  }):msg.$==4?{
   $:1,
   $0:Model.New(EndPoint.CompareItems,model.PendingItemValue,model.Items,model.NextId,List.map(function($1)
   {
    return Pair.New($1[0],$1[1]);
   },Client.createPermutations(model.Items)))
  }:msg.$==5?(which=msg.$0,(currentPair=List.head(model.PendingCombinations),(winningItem=which.$==1?currentPair.B:currentPair.A,(console.log((((Runtime$1.Curried3(function($1,$2,$3)
  {
   return $1("Recording option "+PairRankWeb_GeneratedPrintf.p($2)+" from pair "+GeneratedPrintf.p($3));
  }))(Global.id))(which))(currentPair)),updatedModel=Model.New(model.EndPoint,model.PendingItemValue,List.map(function(item)
  {
   return item.Id===winningItem.Id?Item.New(item.Id,item.Votes+1,item.Value):item;
  },model.Items),model.NextId,model.PendingCombinations),List.length(model.PendingCombinations)===1?{
   $:1,
   $0:Model.New(EndPoint.Result,updatedModel.PendingItemValue,updatedModel.Items,updatedModel.NextId,updatedModel.PendingCombinations)
  }:{
   $:1,
   $0:Model.New(updatedModel.EndPoint,updatedModel.PendingItemValue,updatedModel.Items,updatedModel.NextId,List.tail(model.PendingCombinations))
  })))):msg.$==6?{
   $:1,
   $0:Model.New(EndPoint.ItemEntry,model.PendingItemValue,T.Empty,model.NextId,T.Empty)
  }:{
   $:1,
   $0:Model.New(msg.$0,model.PendingItemValue,model.Items,model.NextId,model.PendingCombinations)
  };
 };
 Client.Render=function(model)
 {
  var m;
  m=model.EndPoint;
 ...
 Client.Navigate=function(page,model)
 {
  return Model.New(page,model.PendingItemValue,model.Items,model.NextId,model.PendingCombinations);
 };
 Client.createPermutations=function(items)
 {
  function allPairs(vs)
  {
   var v1;
   return vs.$==1?vs.$1.$==1?(v1=vs.$0,new T({
    $:1,
    $0:[v1,vs.$1.$0],
    $1:allPairs(new T({
     $:1,
  ...
  return Seq.fold(function(acc,values)
  {
   return List.append(acc,allPairs(values));
  },T.Empty,Client.tails(items));
 };
 Client.tails=function(a)
 {
  var vs;
  return a.$==1?(vs=a.$1,new T({
   $:1,
   $0:new T({
    $:1,
    $0:a.$0,
 ...
 App.CreatePaged=function(initModel,update,render)
 {
  function render$1(dispatch,view)
  {
   return(new Pager.New(render,dispatch,view)).get_Doc();
  }
  return App.Create(initModel,update,function($1)
  {
   return function($2)
   {
    return render$1($1,$2);
 ...
 App.WithCustomRouting=function(router,getRoute,setRoute,app)
 {
  return App.withRouting(Var$1.Lens(app.Var,getRoute,function(m,r)
  {
   return setRoute(r,m);
  }),router,getRoute,app);
 };
 ...
 App.Create=function(initModel,update,render)
 {
  ...
  {
   return App.applyAction(dispatch,mdl,update(msg,mdl));
  }
 ...
 App.applyAction=function(dispatch,oldModel,a)
 {
  function f(newModel,action)
  {
   var o;
   o=App.applyAction(dispatch,newModel==null?oldModel:newModel.$0,action);
 ...
 Model.New=function(EndPoint$1,PendingItemValue,Items,NextId,PendingCombinations)
 {
  return{
   EndPoint:EndPoint$1,
   PendingItemValue:PendingItemValue,
   Items:Items,
   NextId:NextId,
   PendingCombinations:PendingCombinations
  };
 };
 EndPoint.CompareItems={
  $:2
 };
 EndPoint.Result={
  $:3
 ...
 Item.New=function(Id,Votes,Value)
 {
  return{
   Id:Id,
   Votes:Votes,
 ...
 PairRankWeb_JsonEncoder.j=function()
 {
  return PairRankWeb_JsonEncoder._v?PairRankWeb_JsonEncoder._v:PairRankWeb_JsonEncoder._v=(Provider.EncodeRecord(void 0,[["EndPoint",PairRankWeb_JsonEncoder.j$1,0],["PendingItemValue",Provider.Id(),0],["Items",Provider.EncodeList(Provider.Id()),0],["NextId",Provider.Id(),0],["PendingCombinations",Provider.EncodeList(Provider.Id()),0]]))();
 };
 PairRankWeb_JsonDecoder.j=function()
 {
  return PairRankWeb_JsonDecoder._v?PairRankWeb_JsonDecoder._v:PairRankWeb_JsonDecoder._v=(Provider.DecodeRecord(void 0,[["EndPoint",PairRankWeb_JsonDecoder.j$1,0],["PendingItemValue",Provider.Id(),0],["Items",Provider.DecodeList(Provider.Id()),0],["NextId",Provider.Id(),0],["PendingCombinations",Provider.DecodeList(Provider.Id()),0]]))();
 };
 PairRankWeb_GeneratedPrintf.p=function($1)
 {
  return $1.$==1?"B":"A";
 };
 GeneratedPrintf.p=function($1)
 {
  return"{"+("A = "+GeneratedPrintf.p$1($1.A))+"; "+("B = "+GeneratedPrintf.p$1($1.B))+"}";
 };
 ...
 PairRankWeb_Templates.itemtemplate=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 PairRankWeb_Templates.itemstemplate=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 PairRankWeb_Templates.itementrypage=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 PairRankWeb_Templates.comparisontemplate=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
   $0:"comparisontemplate"
  },h):void 0;
 };
 PairRankWeb_Templates.resultsitemtemplate=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
   $0:"resultsitemtemplate"
  },h):void 0;
 };
 PairRankWeb_Templates.resultstemplate=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 {
  return"{"+("Id = "+Utils.prettyPrint($1.Id))+"; "+("Votes = "+Utils.prettyPrint($1.Votes))+"; "+("Value = "+Utils.prettyPrint($1.Value))+"}";
 };
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.initialModel=Model.New(EndPoint.Home,"",T.Empty,0,T.Empty);
  SC$1.MainPage=Page.Single(function(dispatch)
  {
   return function()
   {
    var b,t,p,i;
    return(b=(t=new ProviderBuilder.New$1(),(t.h.push(Handler.EventQ2(t.k,"clicknext",function()
    {
     return t.i;
    },function()
    {
     dispatch({
      $:0,
      $0:EndPoint.ItemEntry
     });
    })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],PairRankWeb_Templates.mainpage(p[0])),b.i=i,i))).get_Doc();
   };
  },null,null,null);
  SC$1.ItemEntry=Page.Single(function(dispatch)
  {
   return function(model)
   {
    var b,C,b$1,I,_this,I$1,_this$1,p,i,_this$2,t,A,_this$3,t$1,v,_this$4,C$1,_this$5,t$2,p$1,i$1;
    function f(a)
    {
     return{
      $:3,
    ...
    return(b=(C=(b$1=(I=Doc.Convert(function(item)
    {
     var b$2,_this$6,t$3,p$2,i$2;
     return(b$2=(_this$6=(t$3=new ProviderBuilder.New$1(),(t$3.h.push(Handler.EventQ2(t$3.k,"removeitem",function()
     {
      return t$3.i;
     },function(e)
     {
      ...
      $0:"value",
      $1:item.Value
     }),_this$6)),(p$2=Handler.CompleteHoles(b$2.k,b$2.h,[]),(i$2=new TemplateInstance.New(p$2[1],PairRankWeb_Templates.itemtemplate(p$2[0])),b$2.i=i$2,i$2))).get_Doc();
    },View.Map(function($1)
    {
     return $1.Items;
    },model)),(_this=(I$1=AttrModule.DynamicProp("hidden",View.Map(function($1)
    {
     return $1.Disabled;
    },View.Map(function(model$1)
    {
     return Disabled.New(List.length(model$1.Items)===0);
    },model))),(_this$1=new ProviderBuilder.New$1(),(_this$1.h.push({
     $:3,
     $0:"itemsheaderattr",
     $1:I$1
     ...
     $0:"itemshole",
     $1:I
    }),_this))),(p=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i=new TemplateInstance.New(p[1],PairRankWeb_Templates.itemstemplate(p[0])),b$1.i=i,i))).get_Doc(),(_this$2=(t=(A=AttrModule.DynamicProp("disabled",View.Map(function($1)
    {
     return $1.Disabled;
    },View.Map(function(model$1)
    {
     return Disabled.New(Strings.length(Strings.Trim(model$1.PendingItemValue))===0);
    },model))),(_this$3=(t$1=(v=View.Map(function($1)
    {
     return $1.PendingItemValue;
    },model),(_this$4=(C$1=AttrModule.DynamicProp("disabled",View.Map(function($1)
    {
     return $1.Disabled;
    },View.Map(function(model$1)
    {
     return Disabled.New(List.length(model$1.Items)<2);
    },model))),(_this$5=(t$2=new ProviderBuilder.New$1(),(t$2.h.push(Handler.EventQ2(t$2.k,"clicknext",function()
    {
     return t$2.i;
    },function()
    {
     dispatch(Message.StartVotingPhase);
    })),t$2)),(_this$5.h.push({
     $:3,
     $0:"clicknextattr",
     $1:C$1
    ...
    }),_this$4))),(t$1.h.push(Handler.EventQ2(t$1.k,"additem",function()
    {
     return t$1.i;
    },function()
    {
     dispatch(Message.AddNewItem);
    })),t$1)),(_this$3.h.push({
     $:3,
     $0:"additemattr",
     $1:A
    }),_this$3))),(t.h.push(Handler.EventQ2(t.k,"pendingnewitemkeydown",function()
    {
     return t.i;
    },function(e)
    {
     ...
     $0:"content",
     $1:C
    }),_this$2))),(p$1=Handler.CompleteHoles(b.k,b.h,[["pendingnewitemvar",0]]),(i$1=new TemplateInstance.New(p$1[1],PairRankWeb_Templates.itementrypage(p$1[0])),b.i=i$1,i$1))).get_Doc();
   };
  },null,null,null);
  SC$1.CompareItems=Page.Single(function(dispatch)
  {
   return function(model)
   {
    ...
    }),_this)),(t$1.h.push(Handler.EventQ2(t$1.k,"awins",function()
    {
     return t$1.i;
    },function(e)
    {
     ...
     e.Event.preventDefault();
    })),t$1)),(t.h.push(Handler.EventQ2(t.k,"bwins",function()
    {
     return t.i;
    },function(e)
    {
     ...
     e.Event.preventDefault();
    })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],PairRankWeb_Templates.comparisontemplate(p[0])),b.i=i,i))).get_Doc();
   };
  },null,null,null);
  SC$1.Result=Page.Single(function(dispatch)
  {
   return function(model)
   {
    var b,t,R,_this,p,i;
    return(b=(t=(R=Doc.Convert(function(item)
    {
     var b$1,V,_this$1,_this$2,p$1,i$1;
     return(b$1=(V=(function($1)
     {
      return function($2)
      {
       return $1(Global.String($2));
      };
     }(Global.id))(item.Votes),(_this$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
      $:1,
      $0:"value",
      $1:item.Value
     }),_this$2)),(_this$1.h.push({
      ...
      $0:"votecount",
      $1:V
     }),_this$1))),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],PairRankWeb_Templates.resultsitemtemplate(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
    },View.Map(function(model$1)
    {
     return List.rev(List.sortBy(function(item)
     {
      return item.Votes;
     },model$1.Items));
    },model)),(_this=new ProviderBuilder.New$1(),(_this.h.push({
     $:0,
     $0:"results",
     $1:R
    }),_this))),(t.h.push(Handler.EventQ2(t.k,"startover",function()
    {
     return t.i;
    },function()
    {
     dispatch(Message.Restart);
 ...
 Pages.ItemEntry=function()
 {
  SC$1.$cctor();
  return SC$1.ItemEntry;
 };
 Pages.CompareItems=function()
 {
  SC$1.$cctor();
  return SC$1.CompareItems;
 };
 Pages.Result=function()
 {
  SC$1.$cctor();
  return SC$1.Result;
 };
 ...
 Disabled.New=function(Disabled$1)
 {
  return{
   Disabled:Disabled$1
  };
 ...
 EltUpdater=Client$1.EltUpdater=Runtime$1.Class({
 ...
 FSharpMap=Collections.FSharpMap=Runtime$1.Class({
  ...
  Add:function(k,v)
  {
   return new FSharpMap.New$1(BalancedTree.Add(Pair$1.New(k,v),this.tree));
  },
 ...
 Pair$1=Collections.Pair=Runtime$1.Class({
  Equals:function(other)
  {
